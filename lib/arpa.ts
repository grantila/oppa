...
const defaultOptions: ArpaOptions = {
	name: null,
	version: null,
	description: null,
	noHelp: false,
...
export type ArpaSingleString = { type: 'string'; multi?: false; };
export type ArpaSingleBoolean = { type: 'boolean'; multi?: false; };
export type ArpaSingleNumber = { type: 'number'; multi?: false; };
export type ArpaMultiString = { type: 'string'; multi: true; };
export type ArpaMultiBoolean = { type: 'boolean'; multi: true; };
export type ArpaMultiNumber = { type: 'number'; multi: true; };
...
export type Arpifyer< Name extends string, Type > = { [ P in Name ]: Type };
...
export class Arpa< U >
{
	private readonly opts: ArpaOptions;
	...
	add< T extends string >( argument: Argument< T > & ArpaSingleString )
		: Arpa< U & Arpifyer< T, string > >;
	add< T extends string >( argument: Argument< T > & ArpaSingleBoolean )
		: Arpa< U & Arpifyer< T, boolean > >;
	add< T extends string >( argument: Argument< T > & ArpaSingleNumber )
		: Arpa< U & Arpifyer< T, number > >;
	add< T extends string >( argument: Argument< T > & ArpaMultiString )
		: Arpa< U & Arpifyer< T, Array< string > > >;
	add< T extends string >( argument: Argument< T > & ArpaMultiBoolean )
		: Arpa< U & Arpifyer< T, Array< boolean > > >;
	add< T extends string >( argument: Argument< T > & ArpaMultiNumber )
		: Arpa< U & Arpifyer< T, Array< number > > >;

	add< T extends string >( _argument: Argument )
	: Arpa< U & Arpifyer< T, any > >
	{
	...
	private _parse( _args: ReadonlyArray< string > ): Result< U >
	{
		...
		this.arguments
			.filter( argument => 'default' in argument )
			.forEach( argument =>
			{
...
export function arpa( opts?: Partial< ArpaOptions > ): Arpa< { } >
{
	return new Arpa< { } >( Object.assign( { }, defaultOptions, opts ) );
}
